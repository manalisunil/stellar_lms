        ...
        if(request()->ajax()) {
            ...
            $output.='<div id="removeData">'.
                ...
                '<div class="row">'.
                    ...
                    '</div>'.
                    '<div class="col-lg-3">'.
                        '<input name="course_duration" id="ed_course_duration" type="text" class="form-control" value="'.$courseData->course_duration.'" placeholder="Enter Course Duration" required data-parsley-trigger="focusout" data-parsley-trigger="keyup" data-parsley-pattern="^[A-Za-z _0-9()-/,]*$" />'.
                    '</div>'.
                    '<div class="col-lg-1 pr-0">'.
